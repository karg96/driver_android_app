...
abstract class MySwipeHelper(
    ...
    lateinit var revoverQueue: LinkedList<Int>
...
//        return super.onSingleTapUp(e)
    ...
    private val onTouchListener = View.OnTouchListener { _, motionEvent ->
        ...
        if (motionEvent.action == MotionEvent.ACTION_DOWN ||
            ...
            if (rect.top < point.y && rect.bottom > point.y) {
                ...
                revoverQueue.add(swipePosition)
                swipePosition = -1
                recoverSwipeItem()
            }
        }
    ...
    private fun recoverSwipeItem() {
        while (!revoverQueue.isEmpty()) {
            val pos = revoverQueue.poll()!!.toInt()
            if (pos > -1)
    ...
    init {
        ...
        this.revoverQueue = IntLinkedList()
