package cos.tuk_tuk_driver.utils.recylerviewswipe;
...
public class RecyclerTouchListenerNew implements RecyclerView.OnItemTouchListener, OnActivityTouchListener {
    private static final String TAG = "RecyclerTouchListenerNew";
...
//                    vibe.vibrate(100); // do we really need to add vibrate service
    ...
    public RecyclerTouchListenerNew(Activity a, RecyclerView recyclerView) {
        this.act = a;
...
//        mSwipeListener = listener;
        ...
        rView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                /**
                 * This will ensure that this RecyclerTouchListenerNew is paused during recycler view scrolling.
    ...
    public RecyclerTouchListenerNew setClickable(OnRowClickListener listener) {
        this.clickable = true;
        this.mRowClickListener = listener;
        return this;
    }

    public RecyclerTouchListenerNew setClickable(boolean clickable) {
        this.clickable = clickable;
        return this;
    }

    public RecyclerTouchListenerNew setLongClickable(boolean vibrate, OnRowLongClickListener listener) {
    ...
    public RecyclerTouchListenerNew setLongClickable(boolean longClickable) {
        this.longClickable = longClickable;
        return this;
    }

    public RecyclerTouchListenerNew setIndependentViews(Integer... viewIds) {
        this.independentViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public RecyclerTouchListenerNew setUnClickableRows(Integer... rows) {
        this.unClickableRows = new ArrayList<>(Arrays.asList(rows));
        return this;
    }

    public RecyclerTouchListenerNew setIgnoredViewTypes(Integer... viewTypes) {
    ...
    public RecyclerTouchListenerNew setSwipeable(int foregroundID, int backgroundID, OnSwipeOptionsClickListener listener) {
        this.swipeable = true;
        ...
        if (act instanceof RecyclerTouchListenerNewHelper)
            ((RecyclerTouchListenerNewHelper) act).setOnActivityTouchListener(this);
    ...
    public RecyclerTouchListenerNew setSwipeable(boolean value) {
    ...
    public RecyclerTouchListenerNew setSwipeOptionViews(Integer... viewIds) {
        this.optionViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public RecyclerTouchListenerNew setUnSwipeableRows(Integer... rows) {
    ...
    public RecyclerTouchListenerNew setViewsToFade(Integer... viewIds) {
        this.fadeViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    // the entire foreground is faded out as it is opened
    public RecyclerTouchListenerNew setFgFade() {
...
//                        }
    ...
    public interface RecyclerTouchListenerNewHelper {
